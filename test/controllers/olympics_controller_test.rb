...
class OlympicsControllerTest < ActionController::TestCase
  ...
  test "should create olympic" do
    assert_difference('Olympic.count') do
      post :create, olympic: { athelete_name: @olympic.athelete_name, country: @olympic.country, event: @olympic.event, event_date: @olympic.event_date, medal_type: @olympic.medal_type }
    end
  ...
  test "should update olympic" do
    patch :update, id: @olympic, olympic: { athelete_name: @olympic.athelete_name, country: @olympic.country, event: @olympic.event, event_date: @olympic.event_date, medal_type: @olympic.medal_type }
    assert_redirected_to olympic_path(assigns(:olympic))
  end
